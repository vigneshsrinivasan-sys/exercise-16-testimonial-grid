...
**Primary practice:** Repeated testimonial cards and grid composition

## What I built

Testimonial cards repeat a shared structure with location metadata, a constrained grid width, shadows, transforms, and hover treatment.
